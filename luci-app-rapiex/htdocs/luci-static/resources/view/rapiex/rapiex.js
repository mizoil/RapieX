...
return view.extend({
    async render() {
        ...
        m = new form.Map('rapiex', _('RapieX configuration'), null, ['main', 'second']);
        ...
        o = s.taboption('basic', form.DynamicList, 'domain_list', _('Service List'), _('Select predefined service for routing') + ' <a href="https://github.com/mizoil/allow-domains" target="_blank">github.com/mizoil/allow-domains</a>');
        ...
        o.inputstyle = 'apply';
        o.onclick = function () {
            return fs.exec('/etc/init.d/rapiex', ['check_three'])
                .then(function (res) {
        ...
        o.description = _('View recent system logs related to rapiex');
        o.inputtitle = _('View Logs');
        o.inputstyle = 'apply';
        o.onclick = function () {
            return fs.exec('/etc/init.d/rapiex', ['check_logs'])
                .then(function (res) {
                    const formattedOutput = formatDiagnosticOutput(res.stdout || _('No output'));
        ...
        o.inputstyle = 'apply';
        o.onclick = function () {
            fs.exec('/etc/init.d/rapiex', ['list_update']);
        ...
        o = s.taboption('basic', form.DynamicList, 'domain_list', _('Service List'), _('Select predefined service networks for routing') + ' <a href="https://github.com/mizoil/allow-domains" target="_blank">github.com/mizoil/allow-domains</a>');
        o.placeholder = 'Service list';
        o.value('russia_inside', 'Russia inside');
        o.value('russia_outside', 'Russia outside');
        o.value('ukraine_inside', 'Ukraine');
